var RADIUS=34;
	...
	function mouseOver(){
		this.querySelector('.progress').setAttribute('stroke','red');
	}
	function mouseOut(){
	...
	infoText="<h3 class='title'>Microsoft on the web</h3><p>Since the first release of the Visual Studio 97 many things have changed in web development </p> ";
	display.innerHTML=infoText;
	display.style.height="300px";
